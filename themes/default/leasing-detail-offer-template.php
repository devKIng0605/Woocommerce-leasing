    ...
    <div id="main-content" class="main-content fl-detail-page">
        <div id="primary" class="content-area">
            <div id="content" class="site-main" role="main">
                        ...
                        <div class="col-12 text-center fl-offset-15">
                            <div class="row">
                                ...
                                <div class="col-3 text-center">
                                    <div id="findleasing-sliders-embed-div" data-findleasing data-width="100%"
                                         data-id="<?php echo $offer_id ?>" data-color=""
                                         data-tax="<?php echo($price_tax ? '1' : '0'); ?>"></div>
              ...
              Bilen er fra <a href="<?php echo $offer['mobile_url']; ?>" target="_blank"><img alt="mobile.de"
                                                                                              src="<?php echo findleasing_plugins_url('assets/mobile-logo.svg'); ?>"
                                                                                              style="height: 16px;"></a>
            </span>
                            <?php } ?>
                        </div>
